...
public abstract class AbstractSQL<T> {
    ...
    public T SET_IF(String sets, boolean condition, String or) {
        return condition ? SET(sets) : SET(or);
    }
    ...
    public T VALUES_IF(String columns, String values, String or, boolean condition) {
        return condition ? VALUES(columns, values) : VALUES(columns, or);
    }
